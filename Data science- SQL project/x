...
NOTE: You need to share the create table queries as well.
Evaluation Rubrics:
1. Batter:
● Types: 3
● Marks per type: 7.5
● Total marks: 22.5
● Marking criteria: 1 mark deduction for each incorrect output order or incorrect
field selection
2. Bowler:
● Types: 2
● Marks per type: 7.5
● Total marks: 15
● Marking criteria: Same as batters
3. Allrounder:
● Marks: 7.5
● Marking criteria: Same as batters
4. Wicketkeeper:
● Marks: 7.5
● Marking criteria:
● 0 marks: No explanation given
● 2 marks: Explanation given, but incorrect
● 4 marks: Explanation partially correct
● 7.5 marks: Acceptable explanation
Additional Questions:
● Each correct output is worth 3.5 marks
● Total marks for additional questions: 35
Visualizations:
● Marks range from 0 to 12.5, depending on the entire presentation
● Total marks for visualizations: 12.5
Please note that the above breakdown represents the information provided.
